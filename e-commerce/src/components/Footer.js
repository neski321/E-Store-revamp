        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center space-x-2 mb-6">
              ...
              <span className="text-xl font-display font-bold">E-Store</span>
            </div>
            <p className="text-gray-400 mb-6 leading-relaxed">
              Your trusted destination for premium products. We're committed to providing exceptional 
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link to="/favorites" className="text-gray-400 hover:text-white transition-colors duration-200">
                  My Favorites
                </Link>
              </li>
              <li>
